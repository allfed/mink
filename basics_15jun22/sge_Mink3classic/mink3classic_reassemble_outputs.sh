...
# the data files
input_file=${chunked_output_data_dir}${X_template%%.*X}_${co2_to_use}_d${plantingDateInMonthShiftInDays/-/n}_${data_file_short_name}
base_input=`basename $input_file`

echo "CF = [$chunk_file] ; IF = [$input_file] ; NT = [$n_threads_total]"
...
if [ $test_exit_code -eq 0 ]; then
  ...
  zip -jq ${output_data_dir}${magic_code}_${X_template%%.*X}_${co2_to_use}_d${plantingDateInMonthShiftInDays/-/n}_${data_file_short_name%%_STATS}_provenance.zip ${chunked_output_data_dir}${X_template%%.*X}_${co2_to_use}_d${plantingDateInMonthShiftInDays/-/n}_${data_file_short_name%%_STATS}*provenance.txt

  # copy over the cols file
  cp ${chunked_output_data_dir}${X_template%%.*X}_${co2_to_use}_d${plantingDateInMonthShiftInDays/-/n}_${data_file_short_name%%_STATS}_0_STATS.cols.txt ${output_data_dir}${magic_code}_${X_template%%.*X}_${co2_to_use}_d${plantingDateInMonthShiftInDays/-/n}_${data_file_short_name}.cols.txt

  # rename the output file...
  mv -v ${output_data_dir}${X_template%%.*X}_${co2_to_use}_d${plantingDateInMonthShiftInDays/-/n}_${data_file_short_name}.txt      ${output_data_dir}${magic_code}_${X_template%%.*X}_${co2_to_use}_d${plantingDateInMonthShiftInDays/-/n}_${data_file_short_name}.txt
  mv -v ${output_data_dir}${X_template%%.*X}_${co2_to_use}_d${plantingDateInMonthShiftInDays/-/n}_${data_file_short_name}.info.txt ${output_data_dir}${magic_code}_${X_template%%.*X}_${co2_to_use}_d${plantingDateInMonthShiftInDays/-/n}_${data_file_short_name}.info.txt
