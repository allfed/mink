...
IR_meta_template=meta_wheat_IR_sradadjusting.SNX
RF_meta_template=meta_wheat_RF_sradadjusting.SNX
...
#  full_file_name_RF=${out_dir}/${file_name}RF.SNX
  full_file_name_IR=${out_dir}/${file_name}sradIR.SNX
  full_file_name_RF=${out_dir}/${file_name}sradRF.SNX
