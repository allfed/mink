...
public class DynamicsTextFileSplitter {
  ...
  public static void main(String commandLineOptions[]) throws Exception {
    ...
    if (commandLineOptions.length == 0) {
      System.out.println("Usage: org.ifpri_converter.DynamicsTextFileSplitter input_basename output_basename skip_header_line\n " +
      		"\n" +
      		"The assumption is that the final column is some sort of unique positive integer identifier.\n" +
      		...
      		"\n" +
      		"skip_header_line should be any non-empty string if the first line of the data file contains column names");
      System.exit(1);
    }
...
//					System.out.println("-- in inner part of main if --" + rowIndex);
					...
					outInfoWriterObject.print((rowsInThisBlock*finalColIndex) + "\t = Total Number of Elements\n");
