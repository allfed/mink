...
public class FSCotton
	...
	/// info adapted from
	// http://extension.missouri.edu/publications/DisplayPub.aspx?P=G4256 (we're gonna try two applications: at planting and a little after)
	// http://extension.missouri.edu/publications/DisplayPub.aspx?P=G4270 (a little after will be defined as 17 days: from mid may to early june)
