...
public class DSSATRunnerIrrigation45Heuristic {
...
//	private static final String[] extraNames     = {"DWAP", "CWAM", "HWAM", "HWAH", "BWAH", "PWAM", "HWUM", "H#AM", "H#UM", "HIAM", "LAIX", "IR#M", "IRCM",
...
//	private static final int[] extraStartIndices = new int[] {118,123,131,139,147,155,161,169,175,183,189,195,202,207,214,219,225,231,237,244,249,255,
//		261,267,273,279,285,291,297,303,309,315,321,327,333,339,345,351,358,365,372,379,387,395,404,413,422,431,440,449,458,};
//	private static final int[] extraEndIndices   = new int[] {    123,131,139,147,155,161,169,175,183,189,195,202,207,214,219,225,231,237,244,249,255,261,
//		    267,273,279,285,291,297,303,309,315,321,327,333,339,345,351,358,365,372,379,387,395,404,413,422,431,440,449,458,467,};
//	private static final int[] extraEndIndices   = new int[] {122,130,138,146,154,160,168,174,182,188,194,201,206,213,218,224,230,236,243,248,254,260,
...
//	private int badPlantingWindow = 9;
	...
	public DSSATRunnerIrrigation45Heuristic() {
...
//			System.out.println("     %% reading attempt #" + nTries + " %%");
			...
			if (initialSleepTimeToUseHappy <= 0) {
				initialSleepTimeToUseHappy = (long)readingTimesHappy.getMean();
				readingTimesHappy.reset();
			}
			...
			nTries++;
//			System.out.println("           about to try to read [" + magicDSSATSummaryToReadPath + "] ... #" + nTries);
...
//				System.out.println("           in try below read; length = " + candidateSummaryContents.length);
...
//			System.out.println("    --- out of try/catch for reading; last length = " + candidateSummaryContents[candidateSummaryContents.length - 1].length() + " ---");
			if (
...
//			happyEmergenceDates.useLongValue(daysSincePlantingForEvent);
	...
	private void grabNewManyResults(int nYears) throws InterruptedException, Exception {
		...
		while (!readSuccessfully) {
			...
			// make sure the sleep time is positive...
			// Beware the MAGIC NUMBER!!!
			if (initialSleepTimeToUse <= 0) {
				initialSleepTimeToUse = (long)readingTimesReal.getMean();
				readingTimesReal.reset();
			}
