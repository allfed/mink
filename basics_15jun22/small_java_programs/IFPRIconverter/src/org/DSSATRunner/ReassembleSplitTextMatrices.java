...
public class ReassembleSplitTextMatrices {
	...
	public static void main(String commandLineOptions[]) throws Exception {
		...
		if (commandLineOptions.length != 3) {
			...
			System.out.println();
			System.out.println("This restores a split up matrix.");
		}
		...
		FunTricks.reassembleMatrixTextFileByLinesInfixBeforeUnderscore(originalBaseName, outputPrefix, nChunks);
