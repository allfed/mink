...
public class MagicHCSeqReader {
  ...
  public static void main(String commandLineOptions[]) throws Exception {
    ...
    if (commandLineOptions.length == 0) {
      System.out.println("Usage: org.ifpri_converter.MagicHCSeqReader input_filename output_filename\n ");
      System.exit(1);
    }
...
//    double nRows = 180 / cellSize;
    ...
    for (int lineIndex = 0; lineIndex < rawData.length; lineIndex++) {
    	...
    	FunTricks.appendLineToTextFile(latitude + "\t" + longitude + "\t" + value, outputFilename, appendPlease);
