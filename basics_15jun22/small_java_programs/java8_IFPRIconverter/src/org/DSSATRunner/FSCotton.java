...
public class FSCotton implements NitrogenOnlyFertilizerScheme {
  ...
  /// info adapted from
  // http://extension.missouri.edu/publications/DisplayPub.aspx?P=G4256 (we're gonna try two
  // applications: at planting and a little after)
  // http://extension.missouri.edu/publications/DisplayPub.aspx?P=G4270 (a little after will be
  // defined as 17 days: from mid may to early june)
  ...
  public String buildNitrogenOnlyBlock(
    ...
    rateAppliedKgPerHa[0] = (int) Math.min(nitrogenFertilizerAmount, 34); // 34 kg/ha ~ 30 lb/acre
    daysAfterPlantingForApplication[0] = 17;
    rateAppliedKgPerHa[0] = (int) nitrogenFertilizerAmount - rateAppliedKgPerHa[0];
