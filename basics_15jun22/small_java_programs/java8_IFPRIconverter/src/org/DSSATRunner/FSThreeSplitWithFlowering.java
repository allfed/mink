...
public class FSThreeSplitWithFlowering
	...
	public FSThreeSplitWithFlowering() {
    ...
    rateAppliedKgPerHa[0] = (int)(nitrogenFertilizerAmount / 3);
		daysAfterPlantingForApplication[1] = 31;
    rateAppliedKgPerHa[1] = (int)(nitrogenFertilizerAmount / 3);
