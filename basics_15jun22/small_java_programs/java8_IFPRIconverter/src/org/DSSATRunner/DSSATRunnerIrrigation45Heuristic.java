...
public class DSSATRunnerIrrigation45Heuristic {
  ...
  //	private static final String[] extraNames     = {"DWAP", "CWAM", "HWAM", "HWAH", "BWAH", "PWAM",
  // "HWUM", "H#AM", "H#UM", "HIAM", "LAIX", "IR#M", "IRCM",
  //		"PRCM", "ETCM", "EPCM", "ESCM", "ROCM", "DRCM", "SWXM", "NI#M", "NICM", "NFXM", "NUCM",
  // "NLCM", "NIAM", "CNAM", "GNAM", "PI#M", "PICM", "PUPC", "SPAM",
  //		"KI#M", "KICM", "KUPC", "SKAM", "RECM", "ONTAM", "ONAM", "OPTAM", "OPAM", "OCTAM", "OCAM",
  // "DMPPM", "DMPEM", "DMPTM", "DMPIM", "YPPM", "YPEM", "YPTM", "YPIM",};
  //	private static final int[] extraStartIndices = new int[]
  // {118,123,131,139,147,155,161,169,175,183,189,195,202,207,214,219,225,231,237,244,249,255,
  //
  //	261,267,273,279,285,291,297,303,309,315,321,327,333,339,345,351,358,365,372,379,387,395,404,413,422,431,440,449,458,};
  //	private static final int[] extraEndIndices   = new int[] {
  // 123,131,139,147,155,161,169,175,183,189,195,202,207,214,219,225,231,237,244,249,255,261,
  //
    ...
    for (int lineIndex = 0; lineIndex < nLinesInDataFile; lineIndex++) {
      ...
      for (int plantingWindowIndex = 0;
        ...
        if (phenologyInDays[0] >= this.happyYieldThresholdToDoRealRuns
          ...
          //				Runtime.getRuntime().exec(dssatExecutionCommand , null ,
          // pathToDSSATDirectoryAsFile);
          theRunningProcess =
              Runtime.getRuntime().exec(dssatExecutionCommand, null, pathToDSSATDirectoryAsFile);
