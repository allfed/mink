...
public class FSMiddleHeavyThreeSplitWithFlowering
	...
	public FSMiddleHeavyThreeSplitWithFlowering() {
    ...
    /////////////////////
  	...
  	////////////////////////////////////////
  	    int magicDaysToAnticipateFlowering = 5;

		daysAfterPlantingForApplication[0] = 1;
    rateAppliedKgPerHa[0] = (int)(nitrogenFertilizerAmount * 0.2);
		daysAfterPlantingForApplication[1] = Math.max(Math.round(25.0F / 67.0F * (daysAfterPlantingAnthesis - magicDaysToAnticipateFlowering) ),daysAfterPlantingForApplication[0] + 1);
    rateAppliedKgPerHa[1] = (int)(nitrogenFertilizerAmount * 0.5);
  	daysAfterPlantingForApplication[2] = Math.max(daysAfterPlantingAnthesis - magicDaysToAnticipateFlowering, daysAfterPlantingForApplication[1] + 1);
    rateAppliedKgPerHa[2] = (int)nitrogenFertilizerAmount - rateAppliedKgPerHa[0] - rateAppliedKgPerHa[1];
