...
public class WriteCopyBlockForDailyWeather {
  ...
  public static void main(String commandLineOptions[]) throws Exception {
    ...
    // MatrixOperations.read2DMFMfromTextForceFormat(gisDataTablePath + "_data",formatIndexToForce);
    MultiFormatMatrix geogMatrix =
        MatrixOperations.read2DMFMfromTextForceFormat(
            gisDataTablePath + "_geog", formatIndexToForce);
    ...
    for (int lineIndex = 0; lineIndex < nLinesInDataFile; lineIndex++) {
      ...
      //          idNumber = geogMatrix.getValue(lineIndex,idColIndex); // 67 is the column index
      // for
      ...
      //          finalWeatherFileLocation = outputDirectory + "/" + outputFilename + "_" + latitude
      // + "n_" + longitude + "e" + ".WTH";
