...
//  	int totalAppliedSoFar = -4;
  	...
  	//
  	// thinking in terms of days. total maturity length is around 270 or 290 days; anthesis at about 220 or 240 days.
  	...
  	if (daysAfterPlantingAnthesis < 3) {
  		System.out.println("FSWinterWheat: unlikely flowering: " + daysAfterPlantingAnthesis + "; resetting to 3 for lack of better option");
  		daysAfterPlantingAnthesis = 3;
//  		throw new Exception();
  	}
  	int daysSecondApplication = (int)Math.round(fractionToSecondApplication * daysAfterPlantingAnthesis);
  	int daysThirdApplication  = (int)Math.round(fractionToThirdApplication  * daysAfterPlantingAnthesis);
