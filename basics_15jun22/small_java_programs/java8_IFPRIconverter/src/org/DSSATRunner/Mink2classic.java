...
//		dssatExecutionCommand[2] = magicInitializationFile;
		...
		} else if (cropFertilizerSchemeToUse.equalsIgnoreCase(this.cassavaString)) {
			nitrogenFertilizerScheme = new FSAllAtPlanting();
...
//			throw new Exception();
		...
		if (irrigationSchemeToUse.equalsIgnoreCase(this.maizeString)) {
			...
			irrigationScheme = new IrriSNone();
		} else if (irrigationSchemeToUse.equalsIgnoreCase(this.cassavaString)) {
			irrigationScheme = new IrriSNone();
...
//			weatherExecutionCommand[1] = Integer.toString(fakePlantingYear); // this is the start date code
			...
			weatherExecutionCommand[2] = Integer.toString((fakePlantingYear + nFakeYears + 35) * 1000 + 1); 
...
//				}
				...
				if ( this.cropFertilizerSchemeToUse.equalsIgnoreCase(this.cassavaString)) {
