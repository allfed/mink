...
public class FSZeroItOut implements NitrogenOnlyFertilizerScheme {
  ...
  public String buildNitrogenOnlyBlock(
    ...
    int maxNumberOfApplications = 1; // we want a single application of zero....
    ...
    // super simple: apply zero fertilizer on day #3 and that is it.
    // Beware the MAGIC NUMBER!!! zero fertilizer on day #3.
    int[] daysAfterPlantingForApplication = {3};
    int[] rateAppliedKgPerHa = {0};
