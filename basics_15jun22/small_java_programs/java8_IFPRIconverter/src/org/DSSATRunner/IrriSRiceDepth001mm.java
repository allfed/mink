...
public class IrriSRiceDepth001mm implements IrrigationScheme {

  private boolean readyToCreateBlock = false;

  public IrriSRiceDepth001mm() {
  ...
  private double fixedFloodDepth =
      1.0; // mm; this is to try out different depths to see if we can get different water usages
  // and yields.
