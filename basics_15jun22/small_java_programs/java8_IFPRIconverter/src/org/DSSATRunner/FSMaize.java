...
public class FSMaize implements NitrogenOnlyFertilizerScheme {
  ...
  public String buildNitrogenOnlyBlock(
    ...
    if (nitrogenFertilizerAmount < 20) {
      ...
      daysAfterPlantingForApplication[1] =
          (int)
              ((dapFertilizerRegimeBegins + dapFertilizerRegimeFinishes)
                  / (nApplicationsAfterInitial + 1));
      ...
      rateAppliedKgPerHa[(int) nApplicationsAfterInitial] =
          (int) nitrogenFertilizerAmount - totalAppliedSoFar;
