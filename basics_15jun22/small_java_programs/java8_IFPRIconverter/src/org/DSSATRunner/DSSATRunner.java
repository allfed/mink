...
public class DSSATRunner {
  ...
  private static final int[] extraStartIndices =
      new int[] {189, 195, 201, 225, 231, 249, 255, 261, 267, 273, 279, 285};
  private static final int[] extraEndIndices =
      new int[] {194, 200, 206, 230, 236, 254, 260, 266, 272, 278, 284, 290};
  ...
  public void setMagicDSSATSummaryLineIndexToRead(int magicDSSATSummaryLineIndexToRead) {
  ...
  public void setMagicHarvestedWeightAtHarvestEndIndex(int magicHarvestedWeightAtHarvestEndIndex) {
  ...
  private int[] grabHappyResults(int nHappyYears)
  ...
  public void doSimulationsMultipleYears() throws Exception {
    ...
    for (int lineIndex = 0; lineIndex < nLinesInDataFile; lineIndex++) {
      ...
      cliStuffToWrite =
          DSSATHelperMethods.cliFileContentsMFM(dataMatrix, geogMatrix, lineIndex, SWmultiplier);
