    ...
    /////////////////////
  	...
  	if (nitrogenFertilizerAmount <= 2 * maxFertilizerInOneApplication) {
  	  ...
  	  storageIndex = 2;
  		...
  		daysAfterPlantingForApplication[storageIndex] = daysAfterPlantingForApplication[storageIndex - 1] + daysBetweenApplications;
  		rateAppliedKgPerHa[storageIndex] = Math.min(maxFertilizerInOneApplication,fertilizerLeftToApply);
