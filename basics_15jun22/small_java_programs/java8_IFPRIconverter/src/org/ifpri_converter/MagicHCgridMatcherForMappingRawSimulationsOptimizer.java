...
public class MagicHCgridMatcherForMappingRawSimulationsOptimizer {
  ...
  public static void main(String commandLineOptions[]) throws Exception {
    ...
    if (commandLineOptions.length == 0) {
      System.out.println(
          "Usage: org.ifpri_converter.MagicHCgridMatcherForMappingRawSimulationsOptimizer"
              + " cell_info_file data_file output_file\n"
              ...
              + "\n"
              + "This particular implementation assumes that there might be multiple cases fitting"
              + " the bill for each pixel.\n"
    ...
    while (cellIDSoilNumberLineContents != null) {
      ...
      if (!cellNotInDataTable) {
        ...
        //							co2ToFind           == dataCo2
        //					);
        //					// if dataCellNumber > cellNumberInMap; i.e., we have overshot when looking within
        // this pixel code
        //
