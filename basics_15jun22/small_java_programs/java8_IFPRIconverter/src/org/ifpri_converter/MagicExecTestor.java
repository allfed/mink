...
public class MagicExecTestor {
  ...
  public static void main(String commandLineOptions[]) throws Exception {
    ...
    File pathToDSSATDirectoryAsFile =
        new File("/export/home/rdrobert/crop_stuff/DSSAT/for_cluster/");

    Process dssatProcess =
        Runtime.getRuntime().exec("silly.sh >> stupid.txt", null, pathToDSSATDirectoryAsFile);
    ...
    String line;
    int linesRead = 0;
    while ((line = dssatBufferedReader.readLine()) != null) {
    ...
    //		dssatOutputLine = new
    // String(magicStdOutRaw,magicHarvestedWeightAtHarvestStartIndex,magicHarvestedWeightAtHarvestLength).trim();
