...
public class MagicConverterSeveral {
  ...
  public static void main(String commandLineOptions[]) throws Exception {
    ...
    if (commandLineOptions.length == 0) {
      System.out.println("Usage: org.ifpri_converter.MagicConverter filename output_base_filename delimiter pixelField dataColumnsCSV\n ");
      System.exit(1);
    }
    ...
    String dataColumnsCSV   = commandLineOptions[4];
    
    System.out.println("The delimiter is [" + delimiter + "]");
    
    // parse the dataColumnsCSV to an array of integers
    String commaString = ",";
    String[] dataColumnsStrings = dataColumnsCSV.split(commaString);
    int nValueFields = dataColumnsStrings.length;
