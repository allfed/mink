...
public class Config {
    ...
    public static Config importConfigCSV(String config_file)
          throws InterruptedException, IOException {
            ...
            String all_properties = "region_to_use_n region_to_use_s region_to_use_e region_to_use_w nsres ewres co2_level run_descriptor minimum_physical_area winter_wheat_countries_csv irrigation_to_try weather_prefix weather_folder results_folder planting_months years real_or_happy all_or_crop_specific run_crop_model process_results calculate_as_wet_weight average_yields calculate_average_production_over_time find_best_yields calculate_rf_or_ir_specific_average_yield calculate_rf_or_ir_specific_production calculate_rf_plus_ir_production calculate_average_yield_rf_and_ir make_rasters_comparing_overall_to_historical create_each_year_png create_average_png create_overall_png nitrogen_irrigated nitrogen_rainfed nitrogen ";
            ...
            while (scanner.hasNextLine()) {
                ...
                if (line.startsWith("region_to_use_n: ")) {
                    ...
                    all_properties = all_properties.replace("calculate_average_production_over_time ","");
                    ...
                    all_properties = all_properties.replace("make_rasters_comparing_overall_to_historical ","");
            ...
            System.out.println(all_properties);
            assert all_properties.equals("nitrogen ") || all_properties.equals("nitrogen_irrigated nitrogen_rainfed ")  : "remaining unspecified properties in config yaml file can either have only nitrogen field specified, or at least one crop with nitrogen_irrigated and nitrogen_rainfed specified\n (if you specify the nitrogen, this is integer kg/ha in all cropland. If you specify raster maps for each crop, you need irrigated and rainfed raster nitrogen maps in kg/ha, which should be loaded in the initialization, which can be found in the prerun_scripts/upack_all_nitrogen_rasters.sh)";
          return config;
