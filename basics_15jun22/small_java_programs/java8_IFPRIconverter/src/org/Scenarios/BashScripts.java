...
// The BashScripts class is a utility class that allows you to run Bash scripts from Java. It contains several methods that build a ProcessBuilder object with the necessary arguments and then call the callProcess method to execute the script.

// The initGRASS method initializes a GRASS environment with the given region and resolution parameters. The runScenario method runs a DSSAT scenario using the given inputs. The processResults method processes the results of a scenario run.

// The runAverageCropsCommand method averages the yield rasters for a set of scenarios, and the calculateProduction method calculates production for rainfed and irrigated scenarios using the averaged yields and the crop area raster.
...
public class BashScripts {
  ...
  public static void processResults(
      String script_folder, String snx_name, String yield_result_name)
      throws InterruptedException, IOException {

    System.out.println("");
    System.out.println("Raster result name");
  ...
  public static void calculateProduction(
      String script_folder, String scenario_tag_for_averaging, String crop_area_raster, String scenario_tag_for_production) throws InterruptedException, IOException {
    ...
    ProcessBuilder pb =
        new ProcessBuilder(
            "bash", "./calculate_production.sh", scenario_tag_for_averaging, crop_area_raster,scenario_tag_for_production);
  ...
  public static void sumRasters(
      String script_folder, String rasters_to_add, String sum_raster, String results_folder) throws InterruptedException, IOException{

    ProcessBuilder pb =
        new ProcessBuilder(
            "bash", "./sum_production_and_save.sh", rasters_to_add, sum_raster, 
            "../../../" + results_folder);
  ...
  public static void compositeRaster(
      String script_folder, String combined_yield_results, String best_yield_raster, String best_month_raster, String results_folder) throws InterruptedException, IOException{
    ...
    ProcessBuilder pb =
        new ProcessBuilder(
            "bash", "./max_yields.sh", combined_yield_results,best_yield_raster, best_month_raster,"../../../" + results_folder);
