...
public class SystemCallWithTimeout extends Thread {
  ...
  public static final int SYSTEM_CALL_RAN_FINE = 0;
  public static final int SYSTEM_CALL_TIMED_OUT = 1;
  public static final int SYSTEM_CALL_NOT_ATTEMPTED = 2;
  ...
  public void setup(
      String[] commandToUse,
      File workingDirectoryToUse,
      int sleepTimeMillisToUse,
      int testIntervalToUse) {
  ...
  public void run() {
    if (readyToGo) {
      ...
      System.out.println(
          this.toString() + " (SystemCallWithTimeout) is not ready to run; please initialize.");
    }
  }
}
