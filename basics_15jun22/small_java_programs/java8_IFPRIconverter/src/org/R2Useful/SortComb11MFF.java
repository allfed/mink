...
public class SortComb11MFF {
  ...
  private void swapRows(MultiFormatFloat sortMatrix, int[] originalRowList, long rowA, long rowB)
      throws Exception {
  ...
  public static MultiFormatFloat reconstructFullSortedMatrix(
      MultiFormatFloat originalMatrix, int[] originalRowIndices) throws Exception {
    MultiFormatFloat sortedMatrix =
        new MultiFormatFloat(originalMatrix.getDataFormat(), originalMatrix.getDimensions());
