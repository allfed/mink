...
public class SortComb11MFM {
	...
	private void  swapRows(MultiFormatMatrix sortMatrix, int[] originalRowList, long rowA, long rowB) throws Exception {
...
//			}
	...
	public static MultiFormatMatrix reconstructFullSortedMatrix(
			MultiFormatMatrix originalMatrix,
			int[] originalRowIndices
	) throws Exception {
		MultiFormatMatrix sortedMatrix = new MultiFormatMatrix(originalMatrix.getDataFormat(),originalMatrix.getDimensions());
