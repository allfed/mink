...
public class SystemCall extends Thread {
  ...
  public void setup(
      String[] commandToUse, File workingDirectoryToUse, DeadDropObjectArray dropPointToUse) {
  ...
  public void interrupt() {
    // sometimes, the process seems to finish up between when the timeout occurs and the attempted
    // destruction
