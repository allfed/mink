...
if [ $# = 0 ]; then
  echo "Usage: v.out.kml.points.sh point_vector output_file readable_name point_name_field [color:red/green/yellow/orange/blue/purple]"
  exit 1
fi
...
# some magical settings... related to size.
scale_adjuster=2.0 # this will multiply the basics to get the real ones we'll use...

     base_scale=0.25 # 0.25 is the smallest that shows up sensibly
highlight_scale=0.5  # 0.5 is a decent value

     real_base_scale=`echo "$scale_adjuster * $base_scale"      | bc`
real_highlight_scale=`echo "$scale_adjuster * $highlight_scale" | bc`

BS=$real_base_scale
HS=$real_highlight_scale
...
<StyleMap id=\"msn_shaded_dot_yellow\">
  <Pair>
    <key>normal</key>
    <styleUrl>#sn_shaded_dot_yellow</styleUrl>
  </Pair>
  <Pair>
    <key>highlight</key>
    <styleUrl>#sh_shaded_dot_yellow</styleUrl>
  </Pair>
</StyleMap>

<StyleMap id=\"msn_shaded_dot_orange\">
  <Pair>
    <key>normal</key>
    <styleUrl>#sn_shaded_dot_orange</styleUrl>
  </Pair>
  <Pair>
    <key>highlight</key>
    <styleUrl>#sh_shaded_dot_orange</styleUrl>
  </Pair>
</StyleMap>

<StyleMap id=\"msn_shaded_dot_purple\">
  <Pair>
    <key>normal</key>
    <styleUrl>#sn_shaded_dot_purple</styleUrl>
  </Pair>
  <Pair>
    <key>highlight</key>
    <styleUrl>#sh_shaded_dot_purple</styleUrl>
  </Pair>
</StyleMap>
...
<Style id=\"sn_shaded_dot_purple\">
  <IconStyle>
    <color>ffa200a2</color>
    <scale>$BS</scale>
    <Icon>
      <href>http://maps.google.com/mapfiles/kml/shapes/shaded_dot.png</href>
    </Icon>
  ...
  <LabelStyle>
    <color>99a200a2</color>
    <scale>0.7</scale>
  </LabelStyle>
</Style>

<Style id=\"sh_shaded_dot_purple\">
  <IconStyle>
    <color>ffa200a2</color>
    <scale>$HS</scale>
    <Icon>
...
description_string=`echo "${description_string}<br>${field_name}: ${field_contents}</br>"`
