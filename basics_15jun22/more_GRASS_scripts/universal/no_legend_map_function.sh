...
{
  echo ""
  echo "Usage: $0 -r raster_name [-v vector_names_csv] -f file_name -s sample_dpi [-l] [-e] [-g gridsize]"
  echo ""
  ...
  echo "-g means put on a geographic grid"
  echo ""
}
...
#vector_names_csv=cntry05_continental # default...
no_name_flag=0
gridsize="" # default to empty and we'll check if it is full...

while getopts g:r:c:v:f:s:lt:en provided_value
do
...
# do the grid block if necessary
gridblock=""
