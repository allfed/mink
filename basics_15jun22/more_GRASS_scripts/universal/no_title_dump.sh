...
if [ $# -lt 2 ]; then
  echo "Usage: no_title_dump.sh raster_name file_name [legend_options=\"options\"] [\"vector [with options]\"] [legend_width=%]"
#  echo "Usage: no_title_dump.sh raster_name file_name \"descriptive blurb\" [legend_options=\"options\"] [\"vector [with options]\"] [legend_width=%]"
...
#export          GRASS_HEIGHT=400 # 600 works for climate1km
#export           GRASS_WIDTH=900 # 1600 works for climate1km
#export          GRASS_HEIGHT=1500
#export           GRASS_WIDTH=1700
...
output_directory="/home/grass/grass_scripts/maps/quick/"
