...
#echo ",,${chunk_value},,"
  ...
  where_statement="$where_statement OR $new_piece"

done

## trim off the initial " OR "
...
~grass/grass_scripts/universal/new_map_function.sh -n -r deleteme_masked_raster -c "$raster_comment" -f $file_name -s $sample_dpi $landscape_flag_to_use $value_options_to_use
