...
public class SortComb11double {
	...
	public String getModuleInfo() {
		return "MffSortComb11. This module sorts a 2-d double matrix by the values in the specified column. That is, " +
...
//		indicesB = new long[2]; // assuming 2-d matrix
	...
	public void doSorting() throws Exception {
		...
		sortedMatrix = new double[nRows]; // new MultiFormatMatrix(originalMatrix.getDataFormat(), theDims);
...
//		int nColsSorted = nCols; // changing because i'm going to keep the list of original indices separate
...
//			}
	...
	public static double[][] reconstructFullSortedMatrix(
		...
		double[][] sortedMatrix = new double[nRows][nCols]; //MultiFormatMatrix(originalMatrix.getDataFormat(),originalMatrix.getDimensions());
