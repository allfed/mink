...
//		irrigationScheme
	...
	public int parseIntegerResults(String[] stringArray,int start,int end,long lineIndex) {
		int valueParsed = -9;
		try {
	...
	public double parseDoubleResults(String[] stringArray,int start,int end,long lineIndex) {
