...
public class OLD_MultiFormatFloat implements Serializable {
...
//    System.out.println("MFM: ending a readObject de-serialization...");
  ...
  public Object clone() {
    OLD_MultiFormatFloat tempClone = null;
    try {
      tempClone = new OLD_MultiFormatFloat(this.dataFormat,this.dimensions);
...
//      System.out.println("[" + byteIndex + "] = " + ReadWriteByteBuffer[byteIndex]);
  ...
  public OLD_MultiFormatFloat(int FormatIndex, long[] dimensions) throws Exception {
    initialize(FormatIndex, dimensions);
  }

  public OLD_MultiFormatFloat(int FormatIndex, long[] dimensions, float initialValue) throws Exception {
    initialize(FormatIndex, dimensions, initialValue);
  }
  
  public OLD_MultiFormatFloat(int FormatIndex, long[] dimensions, String path) throws Exception {
    initializePermanent(FormatIndex, dimensions, path);
  }

  public OLD_MultiFormatFloat(int FormatIndex, long[] dimensions, String path, float initialValue) throws Exception {
    initializePermanentWithValue(FormatIndex, dimensions, path, initialValue);
  }

  public OLD_MultiFormatFloat(String path) throws Exception {
    loadPermanent(path);
  }
