...
if [ $COMPILE_FLAG -eq 1 ]; then
  cd /mnt/data/basics_15jun22/sge_Mink3daily/
  ./compile_java.sh Scenarios.java CalculateProduction.java BashScripts.java Mink3p2daily.java ScenariosProcessor.java ScenariosRunner.java PlantingScenario.java CalculateProduction.java DSSATRunner.java
